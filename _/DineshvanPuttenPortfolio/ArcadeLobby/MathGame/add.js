...
// Function to generate a new math equation and answers
function generate_equation(){ 
  // Randomly generate two numbers between 0 and 12
  var num1 = Math.floor(Math.random() * 13),
      num2 = Math.floor(Math.random() * 13),
      // Generate two random dummy answers (to mislead the user)
      dummyAnswer1 = Math.floor(Math.random() * 10),
      dummyAnswer2 = Math.floor(Math.random() * 10),
      // Array to hold the correct answer and dummy answers
      allAnswers = [],
  ...
  // Display the numbers in the HTML where the equation is shown
...
// Initial call to generate an equation when the page loads
generate_equation();
